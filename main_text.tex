...
\begin{figure}[tbp]
  \begin{center}
    % \includegraphics[]{figures/pdfs/Fig1.pdf}
  \end{center}
...
\begin{figure}[tbp]
  \begin{center}
    % \includegraphics[]{figures/pdfs/Fig5.pdf}
  \end{center}
...
\begin{figure}[tbp]
  \begin{center}
    % \includegraphics[]{figures/pdfs/Fig6.pdf}
  \end{center}
...
To motivate this assumption, we show that there is greater variance in period on a cycle-to-cycle basis than on a cell-to-cell basis (Figure~\ref{fig:cell2cell-variability}).
...
Since the data used in this study is well-described by an exponentially damped sinusoid, and since a mathematical model assuming homogeneous mean periods accurately predicts the experimental damping rate changes, this assumption is likely justified.
Additionally, since this study is mainly concerned with changes in the damping rate (rather than the absolute damping rate), it is unlikely that period heterogeneity plays a major role.
...
\begin{figure}[tbp]
  \begin{center}
    % \includegraphics[]{figures/pdfs/FigS1.pdf}
  \end{center}
...
\begin{figure}[tbp]
  \begin{center}
    % \includegraphics[]{figures/pdfs/FigS2.pdf}
  \end{center}
...
\begin{figure}[tbp]
  \begin{center}
    % \includegraphics[]{figures/pdfs/FigS3.pdf}
  \end{center}
...
\begin{figure}[tbp]
  \begin{center}
    % \includegraphics[]{figures/pdfs/FigS4.pdf}
  \end{center}
